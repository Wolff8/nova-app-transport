...
const CATEGORIES = [
  ...
  { 
    ...
    keys: ['sz_rail', 'orm', 'rinf_network', 'sz_stations', 'rinf', 'sz_crossings', 'delays_heatmap', 'transit', 'eurorail', 'rail_sensors', 'hafas', 'yard', 'freight_modelled', 'tent_railways', 'border_crossings'], 
    icon: Train,
    accent: '#38bdf8'
  },
  { 
